...
import ansible_collections.local.uws.plugins.modules.config_option
...
def test_doc():
    ...
    # Similar to the shell cmd as described in README:
    ...
    #
    ansible_doc = f"from ansible.cli.doc import main; main(['', '{plugin}'])"
